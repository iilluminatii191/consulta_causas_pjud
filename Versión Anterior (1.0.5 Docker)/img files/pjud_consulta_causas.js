console.log('');
console.log('#######################################');
console.log('      IMAGEN DOCKER CORRIENDO OK');
console.log('   Estás ejecutando la versión 1.0.5');
console.log('#######################################');
console.log('');
console.log('Revisa los parámetros que ingreses antes de comenzar');
console.log('Cualquier error que detectes se agradece puedas informarlo para arreglarlo :)');
console.log('');
console.log('');
...
if(actionInput === '1'){
  ...
  action = '2';
  const dir_origenCSV = process.env.DIR_CSV_MODO2 || '';
  console.log(`Ruta de montaje del CSV: ${dir_origenCSV}`); //, ACTION=${action}
