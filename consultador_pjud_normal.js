console.log('debugger rut vale jaja');
...
const rut = process.env.RUT || "76335837";
const dv = process.env.DV || "2";
const year = process.env.YEAR || "2024";
const destino = process.env.DESTINO || '/Users/alexssander/Desktop/ruts vale/16-06-2025/pasaje bus spa/2024';
...
(async () => {
  try {
    ...
    if (actionInput === '1') {
      ...
      action = '2';
      const dir_origenCSV = process.env.DIR_CSV_MODO2 || '/Users/alexssander/Desktop/ruts vale/sky procesadas';
